...
CREATE TABLE IF NOT EXISTS project_revisions (
  ...
  label TEXT NOT NULL,
  status TEXT NOT NULL,
  fabrication_route TEXT NOT NULL DEFAULT 'undecided' CHECK (fabrication_route IN ('printed', 'ready_made', 'none', 'undecided')),
  intended_printer_item_id TEXT REFERENCES inventory_items(id),
  machine_id TEXT,
  material TEXT,
  notes TEXT,
  created_at TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS bom_lines (
  ...
  unit TEXT NOT NULL,
  role TEXT CHECK (role IS NULL OR role IN ('consumed', 'reusable')),
