...
const projectSetupReservationProperty: JsonObject = object({ localRef: idProperty("Unique proposal-local reference."), bomLineLocalRef: idProperty("BOM-line local reference."), id: idProperty("Optional stable reservation identifier."), itemId: idProperty("Inventory item to reserve."), quantity: number("Positive reservation quantity."), unit: string("Optional reservation unit.") }, ["localRef", "bomLineLocalRef", "itemId", "quantity"]);
