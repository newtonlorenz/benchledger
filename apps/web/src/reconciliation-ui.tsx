  ...
  return ( <section className="reconciliation-shell" aria-labelledby={headingId}>
    <header className="reconciliation-header">
      ...
      <div className="reconciliation-header-actions">
        ...
        {onExpertChange && ( <button type="button" className={`mode-toggle reconciliation-mode-toggle ${expert ? "is-expert" : ""}`} aria-pressed={expert} onClick={() => onExpertChange(!expert)}><span className="mode-dot" />{expert ? "Technical details" : "Beginner view"}</button> )}
      </div>
    </header>
