...
type ProjectTab = "plan" | "files" | "offers" | "build" | "reconciliation";
...
function readNavigationUrlState(): { page: Page; projectId?: string; tab: ProjectTab; projectView?: ProjectView; } {
  ...
  const page = parts[0];
  if (page === "projects") {
    const tab = (["plan", "files", "offers", "build", "reconciliation"] as ProjectTab[]).includes(parts[2] as ProjectTab) ? (parts[2] as ProjectTab) : "plan";
