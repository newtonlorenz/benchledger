...
export function WorkbenchHome(props: WorkbenchHomeProps) {
  ...
  return <div className="home-workspace">
    ...
    {!rows.length ? <section className="surface home-onboarding"><h2>Create a project or import its requirements</h2><p>Add inventory when you have stock to record. You do not need a printer to start.</p><div><span><strong>1. Define</strong>Name the project and its required result.</span><span><strong>2. Plan</strong>Add requirements or review a BOM import.</span><span><strong>3. Check</strong>Confirm stock, then review the missing parts.</span></div></section> : <div className="home-status-strip" aria-label="Workspace task shortcuts">
