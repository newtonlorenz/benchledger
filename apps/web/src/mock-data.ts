...
export const inventory: InventoryItem[] = [
  {
    ...
    name: "Bambu Lab H2D",
    category: "Printers",
    categoryNodeId: "category-printers",
    ...
    productProfile: {
      id: "profile-h2d",
      inventoryItemId: "eq-h2d",
      catalogProductId: "catalog-h2d",
      linkState: "confirmed",
      evidence: "commissioned",
      printer: {
        assetLabel: "H2D workshop printer",
        commissionedAt: "2026-08-28",
        location: "Print room",
        condition: "good",
      },
      version: 1,
  ...
  },
  {
    ...
    catalogProduct: {
      ...
      model: "Ender-3 V3 SE",
      variant: "Standard",
      exactModel: "Ender-3 V3 SE",
      exactVariant: "Standard",
      technology: "fff",
    ...
    productProfile: {
      id: "profile-ender-v3-se",
      inventoryItemId: "eq-ender",
      catalogProductId: "catalog-ender-v3-se",
      linkState: "confirmed",
      evidence: "commissioned",
      printer: {
        assetLabel: "Ender workshop printer",
        commissionedAt: "2026-08-28",
        location: "Print room",
        condition: "good",
      },
  ...
  },
  {
    ...
    name: "PETG HF · Black",
    category: "Filament",
    categoryNodeId: "category-filament",
  ...
  },
  {
    ...
    categoryNodeId: "category-printer-parts",
  ...
  },
  {
    ...
    category: "Wire & cable",
    categoryNodeId: "category-electrical",
  ...
  },
  {
    ...
    category: "Fasteners",
    categoryNodeId: "category-fasteners",
  ...
  },
  {
    ...
    category: "Accessories",
    categoryNodeId: "category-printer-accessories",
...
const lampArtifacts: Artifact[] = [
  {
    id: "a-lamp-cad",
    name: "autonomous-lamp.scad",
    role: "Editable CAD",
    revision: "r03",
    workItemId: "sample-work-lamp-enclosure",
    workItemRevisionId: "sample-work-lamp-enclosure-r03",
    size: "42 KB",
    hash: "sha256: 7d9e…e13a",
    updated: "2 hours ago",
    status: "candidate",
  },
  {
    id: "a-lamp-step",
    name: "autonomous-lamp.step",
    role: "STEP",
    revision: "r03",
    workItemId: "sample-work-lamp-enclosure",
    workItemRevisionId: "sample-work-lamp-enclosure-r03",
    size: "1.8 MB",
    hash: "sha256: 1a67…0c91",
    updated: "2 hours ago",
    status: "candidate",
  },
  {
    id: "a-lamp-3mf",
    name: "h2d-lamp-r03.3mf",
    role: "Build plate",
    revision: "r03",
    projectRevisionId: "sample-project-lamp-r03",
    size: "836 KB",
    hash: "sha256: b1fa…a044",
    updated: "1 hour ago",
    status: "validated",
    machine: "Bambu Lab H2D · 0.4 mm",
    material: "PETG HF · Black",
  },
  {
    id: "a-lamp-report",
    name: "fit-notes.md",
    role: "Validation",
    revision: "r02",
    projectRevisionId: "sample-project-lamp-r02",
    size: "6 KB",
    hash: "sha256: 95a2…7b11",
    updated: "Yesterday",
    status: "validated",
  },
];
...
export const projects: Project[] = [
  {
    ...
    updated: "Today, 09:42",
    currentRevision: "r03",
    workItem: "Autonomous lamp enclosure",
    railStep: 3,
    serverRevisionId: "sample-project-lamp-r03",
    projectRevisions: [
      {
        id: "sample-project-lamp-r03",
        number: 3,
        name: "Serviceable enclosure",
        status: "DFAM reviewed",
      },
      {
        id: "sample-project-lamp-r02",
        number: 2,
        name: "Axis fit",
        status: "CAD complete",
      },
    ...
    workItems: [
      {
        id: "sample-work-lamp-enclosure",
        name: "Autonomous lamp enclosure",
        kind: "printed part",
        description: "Printed enclosure and service hatch for the lamp.",
        currentRevisionId: "sample-work-lamp-enclosure-r03",
        currentRevision: {
          id: "sample-work-lamp-enclosure-r03",
          number: 3,
          name: "Service hatch",
          status: "DFAM reviewed",
        },
    ...
    buildConfigSnapshot: {
      id: "sample-setup-lamp-r03",
      projectId: "project-lamp",
      revisionId: "sample-project-lamp-r03",
      projectRevisionId: "sample-project-lamp-r03",
      createdAt: "2026-08-30T09:42:00.000Z",
      version: 1,
      printerItemId: "eq-h2d",
      printerProfileId: "profile-h2d",
      printerProductId: "catalog-h2d",
      filamentItemId: "mat-petg-black",
    ...
    bom: [
      {
        ...
        id: "bom-petg",
        label: "PETG HF · Black",
        itemId: "mat-petg-black",
        required: 400,
        unit: "g",
        note: "Estimated from r03 plate",
        role: "consumed",
      },
      {
        version: 1,
        id: "bom-inserts",
        label: "M3 heat-set inserts",
        itemId: "fast-m3-inserts",
        required: 8,
        unit: "each",
        note: "Physical count needed before allocation",
        role: "consumed",
      },
      {
        version: 1,
        id: "bom-servo",
        label: "STS3215 smart servo",
        required: 1,
        unit: "each",
        note: "Requires 6 V supply and serial control",
        role: "consumed",
      },
      {
        version: 1,
        ...
        required: 1,
        unit: "each",
        note: "Resolve resistance and power rating before sourcing",
        role: "consumed",
      },
      {
        version: 1,
        id: "bom-bearing",
        label: "608-2RS bearing",
        required: 2,
        unit: "each",
        note: "8 × 22 × 7 mm",
        role: "consumed",
  ...
  },
  {
    ...
    railStep: 4,
    serverRevisionId: "sample-project-circadian-r09",
    serverRevisionVersion: 1,
    projectRevisions: [
      {
        id: "sample-project-circadian-r09",
        number: 9,
        name: "Horizon wallwash",
        status: "DFAM reviewed",
      },
    ...
    bom: [
      ...
      {
        version: 1,
        id: "bom-wall-diffuser",
        label: "Opal diffuser sheet",
        required: 1,
        unit: "each",
        optional: true,
        role: "consumed",
    ...
    artifacts: [
      {
        id: "a-wall-cad",
        name: "horizon-wallwash.scad",
        role: "Editable CAD",
        revision: "r09",
        projectRevisionId: "sample-project-circadian-r09",
        size: "36 KB",
        hash: "sha256: 82ca…11d0",
        updated: "Yesterday",
        status: "candidate",
      },
      {
        id: "a-wall-3mf",
        name: "horizon-wallwash.3mf",
        role: "Build plate",
        revision: "r09",
        projectRevisionId: "sample-project-circadian-r09",
        size: "512 KB",
        hash: "sha256: 70e8…3a11",
        updated: "Yesterday",
        status: "validated",
        machine: "Bambu Lab H2D · 0.4 mm",
        material: "PETG HF · Black",
  ...
  },
  {
    ...
    railStep: 5,
    serverRevisionId: "sample-project-battery-r02",
    serverRevisionVersion: 1,
    projectRevisions: [
      {
        id: "sample-project-battery-r02",
        number: 2,
        name: "Memory Loop v2",
    ...
    artifacts: [
      {
        id: "a-battery-cad",
        name: "memory_loop_v2.scad",
        role: "Editable CAD",
        revision: "r02",
        projectRevisionId: "sample-project-battery-r02",
        size: "28 KB",
        hash: "sha256: 8c07…a022",
        updated: "12 Aug 2026",
        status: "validated",
      },
      {
        id: "a-battery-plate",
        name: "plate-shell.3mf",
        role: "Build plate",
        revision: "r02",
        projectRevisionId: "sample-project-battery-r02",
        size: "421 KB",
        hash: "sha256: 0c3e…88b4",
        updated: "12 Aug 2026",
        status: "validated",
        machine: "Creality Ender-3 V3 SE · 0.4 mm",
        material: "PLA Basic · Sage",
      },
      {
        id: "a-battery-validation",
        name: "validation-manifest.json",
        role: "Validation",
        revision: "r02",
        projectRevisionId: "sample-project-battery-r02",
        size: "3 KB",
        hash: "sha256: 9dd2…e031",
        updated: "12 Aug 2026",
        status: "validated",
      },
    ],
...
export const offers: Offer[] = [
  {
    ...
    itemId: "bom-servo",
    supplier: "RobotShop",
    title: "STS3215 serial bus servo",
    priceMinor: 2499,
    currency: "EUR",
    pack: "1 piece",
    eta: "3–5 days",
    url: "https://example.com/robotshop/sts3215",
  ...
  },
  {
    id: "offer-servo-2",
    itemId: "bom-servo",
    supplier: "Makersupply",
    title: "STS3215 smart servo · metal gear",
    priceMinor: 2890,
    currency: "EUR",
    pack: "1 piece",
    eta: "1 week",
    url: "https://example.com/makersupply/sts3215",
  ...
  },
  {
    ...
    itemId: "bom-bearing",
    supplier: "123Bearing",
    title: "608-2RS sealed bearing",
    priceMinor: 380,
    currency: "EUR",
    pack: "2 pieces",
    eta: "2–4 days",
    url: "https://example.com/123bearing/608-2rs",
    observed: "30 Aug 2026",
    preferred: true,
  },
  {
    ...
    title: "608 skate bearing",
    priceMinor: 650,
    currency: "EUR",
    pack: "4 pieces",
    eta: "Check local stock",
    url: "https://example.com/local/608",
    observed: "20 Aug 2026",
  },
  {
    id: "offer-diffuser",
    itemId: "bom-wall-diffuser",
    supplier: "LightParts",
    title: "Opal acrylic diffuser 2 mm",
    priceMinor: 1190,
    currency: "EUR",
    pack: "A4 sheet",
    eta: "4–6 days",
    url: "https://example.com/lightparts/opal-a4",
...
export const activity = [
  {
    id: "activity-1",
    title: "r03 build plate added",
    detail: "Lamp enclosure · 3MF · verified hash",
    time: "1 hour ago",
    tone: "good" as const,
  },
  {
    id: "activity-2",
    title: "PETG HF counted",
    detail: "680 g remaining · Filament shelf A",
    time: "Yesterday",
    tone: "good" as const,
  },
  {
    id: "activity-3",
    title: "M3 inserts need a count",
    detail: "Delivery evidence is not a physical count",
    time: "18 days ago",
    tone: "warn" as const,
  },
  {
    id: "activity-4",
    title: "Horizon wallwash r09 revised",
    detail: "sealed_inner_aperture · design-open",
    time: "21 Aug 2026",
    tone: "info" as const,
  },
];
